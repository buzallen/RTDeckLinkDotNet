...
namespace AppCommon
{
    public partial class DLSettingsFormForKeyFill : Form
    {
        private bool foundDL = false;

        public DLSettingsForKeyFill Settings { get; set; }

        public DLSettingsFormForKeyFill()
        {
            InitializeComponent();
        }
        ...
        private void SettingsForm_Load(object sender, EventArgs e)
        {
            ...
            chkHideKeyWindow.Checked = Settings.HideFakeKeyWindow;
        }
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            Settings.HideFakeKeyWindow = chkHideKeyWindow.Checked;
